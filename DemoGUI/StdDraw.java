...
*/
    ...
    *  as an argument. It can handle action keys
    ...
    public static void main(String[] args) {
        ...
        StdDraw.filledSquare(0.2, 0.8, 0.05);//test draw red square

        StdDraw.setPenColor(StdDraw.BLACK);
        StdDraw.filledSquare(0.8, 0.8, 0.2);
        StdDraw.circle(0.8, 0.2, 0.2);
        StdDraw.setPenColor(StdDraw.RED);
        StdDraw.filledRectangle(0.8, 0.70, 0.12, 0.08);//try to draw in bottom left of black square
        ...
        double[] x1 = { 0.1, 0.2, 0.3, 0.2 };
        double[] y1 = { 0.2, 0.3, 0.2, 0.1 };
        StdDraw.filledPolygon(x1, y1);
        double[] x2 = { 0.07, 0.2, 0.33, 0.2 };
        double[] y2 = { 0.2, 0.33, 0.2, 0.07 };
